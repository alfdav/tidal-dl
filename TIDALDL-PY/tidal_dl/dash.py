...
This module provides a light-weight parser for the ``dash+xml`` manifests
returned by TIDAL's playback API.  It extracts the segment URLs needed to
download audio representations.
"""
